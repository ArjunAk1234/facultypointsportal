...
import React, { useState, useEffect } from "react";
import { Home, History, Users, LogOut, ChevronFirst, ChevronLast, RotateCcw } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { useAuth } from "../Auth/AuthContext"; // use the hook, not the context
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: <Users size={20} />, label: "Users", path: "/admin/add-teacher" },
    { icon: <Users size={20} />, label: "Teachers", path: "/admin/faculty-list" },
    { icon: <RotateCcw size={20} />, label: "Points Reset", path: "/admin/points-reset" },
  ];
